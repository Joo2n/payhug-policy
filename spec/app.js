/* PayHug 정책서 — 해시 라우터 + 렌더러 + 검색
 * 고객센터(payhug-support/app.js)와 같은 렌더러. 사이트 이름·플레이스홀더만 SITE에서 받는다.
...
(function () {
  ...
  const ICONS = {
    ...
    /* 정책서 문서별 아이콘 (build.py가 만드는 id와 1:1) */
    intake: IC('<path d="M4 14h4l1.5 3h5L16 14h4"/><path d="M4 14V6a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8"/><path d="M4 14v4a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-4"/>'),
    overview: IC('<circle cx="12" cy="12" r="9"/><path d="M3.5 12h17M12 3.2a14 14 0 0 1 0 17.6M12 3.2a14 14 0 0 0 0 17.6"/>'),
    terms: IC('<path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H19v15H6.5A2.5 2.5 0 0 0 4 20.5z"/><path d="M8 7.5h7M8 11h5"/>'),
    logic: IC('<rect x="3" y="4" width="7" height="6" rx="1"/><rect x="14" y="14" width="7" height="6" rx="1"/><path d="M10 7h4a3 3 0 0 1 3 3v4"/>'),
    exception: IC('<path d="M12 4.5l8.5 15h-17z"/><path d="M12 10v4M12 16.6v.1"/>'),
    ui: IC('<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 9h18M8 9v11"/>'),
    admin: IC('<path d="M12 3l7.5 3.2v5c0 4.4-3 8.3-7.5 9.6-4.5-1.3-7.5-5.2-7.5-9.6v-5z"/><path d="M9.2 12l2 2 3.6-3.8"/>'),
    open: IC('<circle cx="12" cy="12" r="9"/><path d="M9.6 9.6a2.5 2.5 0 1 1 3.4 2.3c-.7.3-1 .8-1 1.5M12 16.7v.1"/>'),
    conflict: IC('<path d="M7 3v8a4 4 0 0 0 4 4h2a4 4 0 0 1 4 4v2"/><path d="M17 3v6M7 21v-6"/><circle cx="7" cy="3" r="1.6"/><circle cx="17" cy="3" r="1.6"/>'),
  };
      ...
      <section class="hero">
        <div class="wrap">
          ...
          <button class="hero-search" id="hero-search" aria-label="검색 열기">
            ...
            <span class="hs-placeholder">${esc(SITE.searchHint)}</span>
          </button>
        </div>
      </section>
  ...
  async function renderArticle(artId, secId) {
    ...
    document.title = `${art.title} — ${SITE.siteName}`;
